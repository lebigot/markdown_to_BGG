...
1. The BGG markup requires either **lots of clicks**, or **some cumbersome editing** (like extracting the numeric identifier of a board game from its full URL), which is eschewed by `md_to_bgg.py`.
